...
CONNECTOR_REGISTRY: dict[str, ConnectorTypeDef] = {
    ...
    "proton_mail": ConnectorTypeDef(
        ...
        config_fields=[
            ConnectorFieldDef(
                ...
                required=True,
                default="127.0.0.1",
                help_text="Proton Bridge IMAP host",
            ...
            ConnectorFieldDef(
                ...
                required=True,
                default=1143,
                help_text="Proton Bridge IMAP port",
                placeholder="1143",
            ),
            ConnectorFieldDef(
                "smtp_host", "string", default="127.0.0.1", help_text="Proton Bridge SMTP host", placeholder="127.0.0.1"
            ),
            ConnectorFieldDef(
                "smtp_port", "integer", default=1025, help_text="Proton Bridge SMTP port", placeholder="1025"
            ),
            ConnectorFieldDef(
                "username", "string", required=True, help_text="Proton Mail address", placeholder="you@proton.me"
            ),
            ConnectorFieldDef(
                "password", "password", required=True, sensitive=True, help_text="Proton Bridge password"
            ),
            ConnectorFieldDef("sync_interval", "integer", default=30, help_text="Seconds between syncs"),
            ConnectorFieldDef(
                "folders",
                "list",
                default=["INBOX", "Sent"],
    ...
    "signal": ConnectorTypeDef(
        ...
        config_fields=[
            ...
            ConnectorFieldDef(
                "phone_number", "string", required=True, help_text="Registered phone number", placeholder="+1XXXXXXXXXX"
            ),
            ConnectorFieldDef("sync_interval", "integer", default=5, help_text="Seconds between syncs"),
        ],
    ),
    "imessage": ConnectorTypeDef(
        ...
        config_fields=[
            ...
            ConnectorFieldDef("sync_interval", "integer", default=5, help_text="Seconds between syncs"),
            ConnectorFieldDef(
                "include_sms", "boolean", default=True, help_text="Include SMS/MMS messages (not just iMessage)"
            ),
        ],
    ),
    "caldav": ConnectorTypeDef(
        ...
        config_fields=[
            ...
            ConnectorFieldDef(
                "username", "string", required=True, help_text="CalDAV username", placeholder="you@proton.me"
            ),
            ConnectorFieldDef("password", "password", required=True, sensitive=True, help_text="CalDAV password"),
            ConnectorFieldDef("sync_interval", "integer", default=60, help_text="Seconds between syncs"),
            ConnectorFieldDef(
                "calendars",
                "list",
                default=["Personal"],
    ...
    "finance": ConnectorTypeDef(
        ...
        config_fields=[
            ConnectorFieldDef("provider", "string", default="plaid", help_text="Finance provider"),
            ConnectorFieldDef("client_id", "string", required=True, sensitive=True, help_text="Plaid client ID"),
            ConnectorFieldDef("secret", "password", required=True, sensitive=True, help_text="Plaid secret key"),
            ConnectorFieldDef(
                "access_tokens",
                "list",
                required=True,
            ...
            ConnectorFieldDef("sync_interval", "integer", default=3600, help_text="Seconds between syncs"),
            ConnectorFieldDef(
                "large_transaction_threshold", "integer", default=500, help_text="Dollar amount to flag as large"
            ),
        ],
    ),
    "home_assistant": ConnectorTypeDef(
        ...
        config_fields=[
            ...
            ConnectorFieldDef("token", "password", required=True, sensitive=True, help_text="Long-lived access token"),
            ConnectorFieldDef("sync_interval", "integer", default=30, help_text="Seconds between syncs"),
            ConnectorFieldDef(
                "watched_entities",
                "list",
    ...
    "google": ConnectorTypeDef(
        ...
        config_fields=[
            ConnectorFieldDef(
                "email_address", "string", required=True, help_text="Google account email", placeholder="you@gmail.com"
            ),
            ConnectorFieldDef(
                "credentials_file",
                "string",
    ...
    "whatsapp": ConnectorTypeDef(
        ...
        config_fields=[
            ConnectorFieldDef("sync_interval", "integer", default=10, help_text="Seconds between syncs"),
            ConnectorFieldDef(
                "priority_contacts",
                "list",
            ...
            ConnectorFieldDef(
                "max_conversations_per_sync", "integer", default=10, help_text="Max conversations to check per sync"
            ),
        ],
    ),
    "youtube": ConnectorTypeDef(
        ...
        config_fields=[
            ConnectorFieldDef("sync_interval", "integer", default=900, help_text="Seconds between syncs"),
            ConnectorFieldDef("max_videos_per_sync", "integer", default=30, help_text="Max videos to fetch per sync"),
        ],
    ),
    "reddit": ConnectorTypeDef(
        ...
        config_fields=[
            ConnectorFieldDef("sync_interval", "integer", default=600, help_text="Seconds between syncs"),
            ConnectorFieldDef(
                "use_old_reddit", "boolean", default=True, help_text="Use old.reddit.com (more reliable)"
            ),
            ConnectorFieldDef(
                "priority_subreddits",
                "list",
            ...
            ConnectorFieldDef("max_posts_per_sync", "integer", default=25, help_text="Max posts to fetch per sync"),
        ],
    ),
}
