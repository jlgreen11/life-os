...
class TestMobileSidebarHTML:
    ...
    def test_mobile_fab_button_exists(self):
        ...
        assert 'id="mobileSidebarFab"' in TEMPLATE, 'Missing mobile sidebar FAB button: expected id="mobileSidebarFab"'
    ...
    def test_mobile_fab_calls_toggle_function(self):
        ...
        assert 'onclick="toggleMobileSidebar()"' in TEMPLATE, "FAB button must call toggleMobileSidebar() via onclick"
    ...
    def test_mobile_close_calls_toggle_function(self):
        ...
        assert "toggleMobileSidebar()" in sidebar_html, "Close button inside #aiSidebar must call toggleMobileSidebar()"
...
class TestMobileSidebarJS:
    ...
    def test_toggle_function_defined(self):
        ...
        assert "function toggleMobileSidebar()" in TEMPLATE, "Missing toggleMobileSidebar() function in template JS"
    ...
    def test_toggle_function_toggles_mobile_open_class(self):
        ...
        assert "mobile-open" in fn_body, "toggleMobileSidebar() must toggle the 'mobile-open' class"
    ...
    def test_toggle_function_before_end_of_script(self):
        ...
        assert script_end > fn_idx, "toggleMobileSidebar() must appear before </script>"
