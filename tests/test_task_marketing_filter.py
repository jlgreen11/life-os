...
class TestMarketingEmailFilter:
    ...
    def test_filters_noreply_senders(self):
        ...
        for from_addr in test_cases:
            ...
            assert TaskManager._is_marketing_email(payload) is True, f"Should filter {from_addr}"
    ...
    def test_filters_bulk_sender_patterns(self):
        ...
        for pattern in bulk_patterns:
            ...
            payload = {"from_address": from_addr}
            assert TaskManager._is_marketing_email(payload) is True, f"Should filter {pattern}@"
    ...
    def test_allows_similar_personal_addresses(self):
        ...
        for from_addr in test_cases:
            ...
            if not from_addr.startswith("info"):
                assert TaskManager._is_marketing_email(payload) is False, f"Should NOT filter {from_addr}"
    ...
    def test_filters_unsubscribe_emails(self):
        ...
        test_cases = [
            ...
            {
                "from_address": "bob@firm.com",
                "body": "<a href='#'>Unsubscribe</a> You are receiving this email because you signed up.",
            },
        ]
    ...
    def test_case_insensitive_matching(self):
        ...
        for from_addr in test_cases:
            payload = {"from_address": from_addr}
            assert TaskManager._is_marketing_email(payload) is True, f"Should filter {from_addr} (case-insensitive)"
    ...
    def test_allows_real_world_actionable_examples(self):
        ...
        actionable_emails = [
            {"from_address": "boss@company.com", "body": "Please send the budget proposal by Friday"},
            {"from_address": "client@business.org", "snippet": "Can we schedule a call to review the contract?"},
            {
