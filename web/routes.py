...
def register_routes(app: FastAPI, life_os) -> None:
    ...
    async def insights_summary():
        ...
        # -- 2. Linguistic profile: formality score --
        # NOTE: Cadence insights (response_time_baseline, fastest_contacts,
        # communication_peak_hours, channel_cadence) are now generated by the
        # InsightEngine._cadence_response_insights() correlator and stored in
        # the insights table with proper deduplication and staleness TTL.
        try:
